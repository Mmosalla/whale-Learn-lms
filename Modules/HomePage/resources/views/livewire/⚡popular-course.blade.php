    ...
    <div class="container">
        ...
        <div class="row mb-4">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <p class="mb-0">هر موضوعی را در هر زمان مطالعه کنید. هزاران دوره آموزشی را با کمترین قیمت جستجو
                    کنید!</p>
            </div>
        </div>
        ...
        <ul class="nav nav-pills nav-pills-bg-soft justify-content-sm-center mb-4 px-3" id="course-pills-tab"
            ...
            @foreach($this->categories as $category)
                ...
                <li class="nav-item me-2 me-sm-5" wire:click="setSelectedTab({{$category->id}})">
                    <button class="nav-link mb-2 mb-md-0 @if($selected_tab== $category->id) active @endif"
                            id="course-pills-tab-{{$category->id}}" data-bs-toggle="pill"
                            data-bs-target="#course-pills-tabs-{{$category->id}}" type="button" role="tab"
                            aria-controls="course-pills-tabs-{{$category->id}}"
        ...
        <div class="tab-content" id="course-pills-tabContent">
            @foreach($this->categories as $category)
                <!-- Content START -->
                <div class="tab-pane fade show @if($selected_tab== $category->id) active @endif"
                     id="course-pills-tabs-{{$category->id}}" role="tabpanel"
                     aria-labelledby="course-pills-tab-{{$category->id}}">
                    <div class="row g-4">
                        @foreach($category->courses as $course)
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    <!-- Image -->
                                    <img src="{{url('images/courses/'.$course->id .'/'.$course->image)}}"
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <p class="mb-2 text-truncate-2">با تولید سادگی نامفهوم از صنعت چاپ و با استفاده
                                            از طراحان گرافیک</p>
                                        <!-- Rating star -->
