        ...
        <div class="container-fluid px-3 px-xl-5">
            ...
            <div class="navbar-collapse w-100 collapse" id="navbarCollapse">
                    ...
                    <li class="nav-item dropdown dropdown-menu-shadow-stacked">
                        <a class="nav-link bg-primary bg-opacity-10 rounded-3 text-primary px-3 py-3 py-xl-0" href="#"
                           id="categoryMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                                class="bi bi-ui-radios-grid me-2"></i><span>دسته بندی</span></a>
                        <ul class="dropdown-menu" aria-labelledby="categoryMenu">

                            <!-- Dropdown submenu -->
                            @foreach($this->categories as $category)
                                <li class="dropdown-submenu dropend">
                                    <a class="@if($category->child) dropdown-item @endif @endifdropdown-toggle" href="#">{{$category->title}}</a>
                ...
                <ul class="navbar-nav navbar-nav-scroll me-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link active" href="{{route('home')}}" id="demoMenu" aria-expanded="false">صفحه
                            اصلی</a>
                    </li>
                    <li class="nav-item dropdown">
            ...
            <div class="dropdown ms-1 ms-lg-0">
                ...
                <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3"
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="avatar me-3">
                                    <img class="avatar-img rounded-circle shadow"
                                         src="{{url('assets/images/avatar/01.jpg')}}" alt="avatar">
                                </div>
                                <div>
                    ...
                    <!-- Links -->
                    @guest
                        <li><a class="dropdown-item" href="{{route('login')}}"><i class="bi bi-person fa-fw me-2"></i>ورود
                                / ثبت نام</a></li>
                    @endguest
{{--                    @auth--}}
{{--                        @if(auth()->user()->roles)--}}
{{--                            <li><a class="dropdown-item" href="{{route('panel.index')}}"><i--}}
{{--                                        class="bi bi-gear fa-fw me-2"></i>پنل مدیریت</a></li>--}}
{{--                        @endif--}}
{{--                        <li><a class="dropdown-item" href="{{route('student.dashboard')}}"><i--}}
{{--                                    class="bi bi-gear fa-fw me-2"></i>پنل کاربری</a></li>--}}
{{--                        <li><a class="dropdown-item bg-danger-soft-hover" href="{{route('user.cart')}}"><i--}}
{{--                                    class="bi bi-shop fa-fw me-2"></i>سبد خرید</a></li>--}}
