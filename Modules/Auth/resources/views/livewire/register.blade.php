                            ...
                            <form wire:submit="RegisterUser">
                                ...
                                <div class="mb-4">
                                    <div class="form-check">
                                        <input wire:model="remember_me" type="checkbox" class="form-check-input" id="checkbox-1">
                                ...
                                <div class="align-items-center mt-0">
                                    <div class="d-grid">
                                        <button wire:loading.attr="disabled" wire:target="registerUser" class="btn btn-primary mb-0" type="submit">ثبت نام</button>
                                    </div>
                                </div>
                            </form>
                            <!-- Form END -->
