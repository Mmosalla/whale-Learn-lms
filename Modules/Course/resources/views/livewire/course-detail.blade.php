        ...
        <script>
            ...
            document.addEventListener('livewire:init',()=>{
                ...
                Livewire.on('lessonAdded', (event) => {
                    ...
                    toast.fire({
                        icon: 'success',
                        title: 'قسمت دوره باموفقیت اضافه شد',
                        padding: '2em',
                    });
                })
                Livewire.on('addSeason', (event) => {
                    const toast = window.Swal.mixin({
                        toast: true,
                        position: 'bottom',
                        showConfirmButton: false,
                    ...
                    toast.fire({
                        icon: 'success',
                        title: 'فصل دوره باموفقیت اضافه شد',
                        padding: '2em',
                    });
                })
            })
...
{{--Mohsen was here mmosalla36@gamil.com 😎--}}
