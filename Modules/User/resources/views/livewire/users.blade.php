            ...
            <div class="col-12 mt-5 d-sm-flex justify-content-between align-items-center">
                <div class="card-body">
                    <form class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <button wire:click="createUserRoles" type="button" class="btn btn-warning-soft mb-0">افزودن  نقش</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="card bg-transparent border">
        ...
        <div class="card-footer bg-transparent pt-0">
            ...
            <div class="d-sm-flex justify-content-sm-between align-items-sm-center">
                {{$users->links('vendor.livewire.admin-new-bootstrap')}}
            </div>
            <!-- Pagination END -->
        </div>
    </div>
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            Livewire.on('assign.role', (event) => {
                ...
                toast.fire({
                    icon: 'success',
                    title: 'با موفقیت نقش به کاربر اضافه شد',
                    padding: '2em',
                });
            })
        })
